...
set rc [catch {
  ...
  set_property webtalk.parent_dir F:/zynq/fpga/template/build/template.cache/wt [current_project]
  set_property parent.project_path F:/zynq/fpga/template/build/template.xpr [current_project]
  set_property ip_output_repo F:/zynq/fpga/template/build/template.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  add_files -quiet F:/zynq/fpga/template/build/template.runs/synth_1/top.dcp
  read_xdc F:/zynq/fpga/template/hw/constraints/timing.xdc
  link_design -top top -part xc7z015clg485-2
